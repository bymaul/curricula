...
export const EducationForm = () => (
    <SectionFieldArray
        ...
        newItem={() => ({ institution: '', degree: '', date: '', location: '', description: '' })}
        fields={[
            { name: 'institution', label: 'Institution', placeholder: 'University of California' },
            { name: 'degree', label: 'Degree / Major', placeholder: 'B.S. in Computer Science' },
