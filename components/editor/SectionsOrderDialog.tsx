        ...
        <div className="min-h-0 -mx-1">
          <ScrollArea className="h-full p-2">
            <p className="text-xs text-muted-foreground mb-3 px-1">
              Drag to reorder, or toggle visibility with the eye. Hidden
              sections stay in the editor but do not appear on the resume.
            </p>
            <SortableList ids={sectionOrder} onMove={moveSection}>
              {sectionOrder.map((id) => {
                const title = RENDERABLE_SECTIONS.find(
