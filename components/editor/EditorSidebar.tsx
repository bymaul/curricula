...
import { CheckCircle2, ChevronDown, Download, Upload } from 'lucide-react';
...
export function EditorSidebar({ fileInputRef, handleImportData, handleExportData, handleDownloadPdf }: any) {
