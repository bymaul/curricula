const en = {
  ...
  resumes: {
    ...
    favoriteAria: 'Add {title} to favorites',
    unfavoriteAria: 'Remove {title} from favorites',
    newCv: 'New CV',
    newFromExample: 'Start from example',
    sampleTitle: 'Example CV',
    searchPlaceholder: 'Search CVs…',
    searchAria: 'Search CVs',
    sortAria: 'Sort CVs',
    sortRecent: 'Recently updated',
    sortName: 'Name A-Z',
    filterFavorites: 'Favorites',
    noMatches: 'No CVs match your search.',
    clearSearch: 'Clear search',
    showAll: 'Show all CVs',
    noFavorites: 'No favorites yet. Tap the star on a CV to save it.',
    active: 'Active',
